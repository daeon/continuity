...
A fresh agent does not need the old chat. It reads this, checks anything volatile, and keeps going.
...
1. **Read before resuming.** If a continuity file exists, use it before repeating investigation.
